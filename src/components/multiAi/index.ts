/* Multi-AI Actions (Step 8.4 built Consensus/Synthesis views; Step 8.3 adds
   Debate mode and the MultiAiActions entry point that finally wires all
   three together). */
export { ConsensusView, type ConsensusViewProps } from "./ConsensusView";
