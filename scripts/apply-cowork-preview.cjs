...
const repairedSourcePaths = [
  ...
  'src/components/composer/AttachContextControls.tsx','src/components/context/ActiveContextChips.tsx',
  'src/components/context/ContextManagerDialog.tsx','src/components/pipeline/CenterColumn.tsx',
];
...
const nodeNextFixes=[['src/services/modelRegistry.ts','export type { ModelId } from "../stores/types";','export type { ModelId } from "../stores/types.js";'],['src/services/providers/openai.ts','from "../proxyHandler";','from "../proxyHandler.js";'],['src/services/providers/google.ts','from "../proxyHandler";','from "../proxyHandler.js";'],['src/services/providers/xai.ts','from "../proxyHandler";','from "../proxyHandler.js";'],['src/services/providers/deepseek.ts','from "../proxyHandler";','from "../proxyHandler.js";']];
